...
import com.example.healthcheck.domain.common.enums.NamingCode;
...
import static com.example.healthcheck.domain.common.enums.NamingCode.PENDING;
...
public class OrderInsertDTO {
    ...
    public Orders convertToEntity(User user) {
        ...
        return Orders.builder()
                ...
                .orderStatus(PENDING.toString()) // 초기 상태 설정
                .deleteYn(false)
